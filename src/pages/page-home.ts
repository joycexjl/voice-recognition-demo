    ...
    return html`
      <section>
        <div class="header">
          ...
          <p class="description">
            Convert speech to text using Google's Speech-to-Text API. Choose
            between batch processing for pre-recorded audio files or real-time
            streaming for live transcription.
          </p>
        </div>
        ...
        <div class="tab-content">
          ...
          <div
            class="tab-panel ${this._activeTab === 'streaming' ? 'active' : ''}"
          >
